...
#define LOG_HEX_RETURN(_i) LOG_RETURN("%08X", _i)
#define LOG_NDSPI_RETURN(hr) LOG_RETURN("%s", errors::get_ndspi_result_string(hr))
...
#define LOG_STRUCT_RETURN(x) LOG_RETURN("%s", #x)
